...
/**
 * Represents a physical delivery claim (attests physical scarcity).
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class PhysicalDeliveryClaim implements HapClaim {
    @JsonProperty("v")
    private String v;
    ...
    @JsonProperty("type")
    private String type = "physical_delivery";
    ...
    public PhysicalDeliveryClaim() {}

    public PhysicalDeliveryClaim(String method, String recipientName, String domain, String tier, String issuer) {
        this.v = Hap.VERSION;
