...
/**
 * Represents a financial commitment claim (attests monetary commitment).
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class FinancialCommitmentClaim implements HapClaim {
    @JsonProperty("v")
    private String v;
    ...
    @JsonProperty("type")
    private String type = "financial_commitment";
    ...
    public FinancialCommitmentClaim() {}

    public FinancialCommitmentClaim(String method, String recipientName, String domain, String tier, String issuer) {
        this.v = Hap.VERSION;
