...
/**
 * Represents a content attestation claim (sender attests to content truthfulness).
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ContentAttestationClaim implements HapClaim {
    @JsonProperty("v")
    private String v;
    ...
    @JsonProperty("type")
    private String type = "content_attestation";
    ...
    public ContentAttestationClaim() {}

    public ContentAttestationClaim(String method, String recipientName, String domain, String tier, String issuer) {
        this.v = Hap.VERSION;
