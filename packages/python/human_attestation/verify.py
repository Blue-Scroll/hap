...
def is_valid_id(hap_id: str) -> bool:
    """
    ...
    """
    return bool(ID_REGEX.match(hap_id))
...
def _jwk_to_public_key(jwk: Jwk) -> Ed25519PublicKey:
...
def is_claim_expired(claim: Claim) -> bool:
    """
...
def is_claim_for_recipient(claim: Claim, recipient_domain: str) -> bool:
    """
